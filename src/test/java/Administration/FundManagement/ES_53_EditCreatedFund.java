...
public class ES_53_EditCreatedFund extends BaseTest {
	@Test
	public void CreateFund() throws InterruptedException {
		...
		Thread.sleep(3000);
		//Edit Fund
		driver.findElement(By.id(creFund.getProperty("EditFund"))).click();
		Thread.sleep(3000);
		...
		FundName.clear();
		Thread.sleep(5000);
		WebElement UpdateFundButton = driver.findElement(By.id(creFund.getProperty("UpdateFund")));
		UpdateFundButton.click();
		Thread.sleep(5000);
		FundName.sendKeys("Peafowl Inc");
		Thread.sleep(3000);
		WebElement Prefer = driver.findElement(By.id(creFund.getProperty("FundType")));
		Prefer.clear();
		Thread.sleep(1000);
		UpdateFundButton.click();
		Thread.sleep(1000);
