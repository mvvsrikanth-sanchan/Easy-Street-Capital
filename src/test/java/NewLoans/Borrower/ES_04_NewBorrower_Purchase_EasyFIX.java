...
public class ES_04_NewBorrower_Purchase_EasyFIX extends BaseTest {
	@Test
	public void PurchaseEasyFIX() throws InterruptedException {
		...
		Thread.sleep(3000);
		//WebDriverWait Addresses  = new WebDriverWait(driver, Duration.ofSeconds(50));
		//WebElement address =  Addresses.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("Address")));
...
//Property type
		Actions duplexPurchasingFix = new Actions(driver);
		duplexPurchasingFix.moveToElement(driver.findElement(By.id(Bor.getProperty("Duplex")))).click().perform();

		System.out.println("Purchase details validation displayed");
//Purchase Price 
		driver.findElement(By.id(Bor.getProperty("PurchasePriceFix"))).sendKeys("659000");
//What is the rehab budget?
		driver.findElement(By.id(Bor.getProperty("RehabBudgetFix"))).sendKeys("329000");
//Do you want the loan to provide rehab funding?
		Actions Rehab = new Actions(driver);
		Rehab.moveToElement(driver.findElement(By.id(Bor.getProperty("RehabFundNo")))).click().perform();

		System.out.println("Rehab Fund clickable");
		driver.findElement(By.id(Bor.getProperty("RehabFundYes"))).click();
		System.out.println("Rehab Fund Yes clickable");

//What is the total square footage of the property?
		driver.findElement(By.id(Bor.getProperty("EASYFixPropertyArea"))).sendKeys("2500");
//Total bedrooms
		driver.findElement(By.id(Bor.getProperty("EASYFixTotalBedrooms"))).sendKeys("2");
//Total bathrooms
		driver.findElement(By.id(Bor.getProperty("EASYFixTotalBathrooms"))).sendKeys("2");
		Thread.sleep(5000);
//Year built?
		driver.findElement(By.id(Bor.getProperty("EASYFixYearBuilt"))).sendKeys("2020");
//property has a pool
		Actions NoPool = new Actions(driver);
		NoPool.moveToElement(driver.findElement(By.id(Bor.getProperty("EASYFixPoolNo")))).click().perform();

		System.out.println("Pool No clickable");
		driver.findElement(By.id(Bor.getProperty("EASYFixPoolYes"))).click();
		System.out.println("Pool Yes clickable");
		Thread.sleep(3000);
//square footage of the lot
		driver.findElement(By.xpath(Bor.getProperty("EASYFixlotArea"))).sendKeys("1400");
// What is the after-renovated value?
		driver.findElement(By.id(Bor.getProperty("EASYFixRenovationArv"))).sendKeys("350000");
		Thread.sleep(5000);
//Target complete date

		Actions date = new Actions(driver);
		date.moveToElement(driver.findElement(By.id(Bor.getProperty("EASYFixConstruction"))));
		driver.findElement(By.id(Bor.getProperty("EASYFixConstruction"))).sendKeys("31/05/2025");
// occupancyStatus
	WebElement occupancyStatus = driver.findElement(By.id(Bor.getProperty("OccupancyStatus")));
		Select status = new Select(occupancyStatus);
		status.selectByVisibleText("Delivered Vacant");
		Thread.sleep(3000);
		// Collateral Property
		WebElement CollateralPropertyNo = driver.findElement(By.id(Bor.getProperty("EASYFixCollateralPropertyNo")));
		...
		WebElement CollateralPropertyYes = driver.findElement(By.id(Bor.getProperty("EASYFixCollateralPropertyYes")));
		...
		scrollpage.executeScript("window.scrollBy(0,250)", "");
		// Current Loan
		...
		// occupancyStatus
		WebElement occupancyStatuses = driver.findElement(By.id(Bor.getProperty("c.OccupancyStatus")));
		JavascriptExecutor occupancy_Statuses = (JavascriptExecutor) driver;
		occupancy_Statuses.executeScript("arguments[0].click();", occupancyStatuses);
		occupancyStatuses.sendKeys("COE + 7 days");
		Thread.sleep(2000);
		WebElement EstimationValue = driver.findElement(By.id(Bor.getProperty("CollateralEstimatedValue")));
		JavascriptExecutor Value = (JavascriptExecutor) driver;
		Value.executeScript("arguments[0].click();", EstimationValue);
		EstimationValue.sendKeys("687000");
		Thread.sleep(2000);
		WebDriverWait collateralhomeAdresses = new WebDriverWait(driver, Duration.ofSeconds(30));
		collateralhomeAdresses.until(ExpectedConditions.visibilityOfElementLocated(By.name(Bor.getProperty("PropertyHomeAddress")))).sendKeys("California");
		Thread.sleep(3000);
...
//plan for paying off the loan
		Thread.sleep(3000);
//Sale
	WebElement Sale=	driver.findElement(By.xpath(Bor.getProperty("Sale")));
	JavascriptExecutor sale = (JavascriptExecutor)driver;
	sale.executeScript("arguments[0].click();", Sale);
...
//applicable licenses
		driver.findElement(By.id(Bor.getProperty("GeneralContractor"))).click();
		System.out.println("General Contractor clickableES");
		Thread.sleep(1000);
		driver.findElement(By.linkText(Bor.getProperty("PreviousPage"))).click();
//realEstate Borrower
		driver.findElement(By.id(Bor.getProperty("RealEstateBorrower/Agent"))).click();
...
// Clicking Change 
		...
		WebElement Sales=	driver.findElement(By.xpath(Bor.getProperty("Sale")));
		JavascriptExecutor sales = (JavascriptExecutor)driver;
		sales.executeScript("arguments[0].click();", Sales);
		...
		PropertyInfoNext.moveToElement(driver.findElement(By.id(Bor.getProperty("PropertyInfoNext")))).click().perform();
		...
		Address1.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath(Bor.getProperty("RefinancingAddress"))))
				.sendKeys("California");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		// NEXT Click
		Actions PropertyInfo_Next = new Actions(driver);
		PropertyInfo_Next.moveToElement(driver.findElement(By.id(Bor.getProperty("PropertyInfoNext")))).click().perform();
       /*
        *  TAB 6 SUBMIT APP
        */
		Thread.sleep(3000);
		 ...
		 * UploadPhoto.moveToElement(driver.findElement(By.id(Bor.getProperty("uploadPhotoId"))).click()
		 * .perform();
		 * 
		 * WebElement upload = driver.findElement(By.id(Bor.getProperty("uploadPhotoId"));
