...
public class ES_19_NewBorrower_Refinancings__EasyFIX {
  @Test
...
//===========================TAB 2 LOAN PROGRAM
  Thread.sleep(5000);
driver.findElement(By.id("easyFixLoanProgram")).click();
//========================TAB 3 DEAL INFO
...
duplexPurchasingFix.moveToElement(driver.findElement(By.id("triplexRefinancingFix"))).click().perform();

System.out.println("Purchase details validation displayed");
//Purchase Price 
driver.findElement(By.id("purchasePriceRefinanceFix")).sendKeys("659000");
//PURCHASE PROPERTY DATE
Actions date = new Actions(driver);
date.moveToElement(driver.findElement(By.id("purchaseDateRefinanceFix")));
driver.findElement(By.id("purchaseDateRefinanceFix")).sendKeys("29/03/2024");
 // total square footage 

driver.findElement(By.id("propertyAreaRefinanceFix")).sendKeys("2300");
//Total bedrooms
driver.findElement(By.id("totalBedroomsRefinanceFix")).sendKeys("2");
//Total bathrooms
driver.findElement(By.id("totalBathroomsRefinanceFix")).sendKeys("2");
Thread.sleep(5000);

//Year built?
driver.findElement(By.id("yearBuiltRefinanceFix")).sendKeys("2020");
//property has a pool
Actions NoPool = new Actions(driver);
NoPool.moveToElement(driver.findElement(By.id("poolNoRefinanceFix"))).click().perform();

System.out.println("Pool No clickable");
driver.findElement(By.id("poolYesRefinanceFix")).click();
System.out.println("Pool Yes clickable");
Thread.sleep(2000);
//square footage of the lot
driver.findElement(By.id("lotAreaRefinanceFix")).sendKeys("1400");
//Did you renovate the property?
Thread.sleep(2000);
Actions RefinanceLoan = new Actions(driver);
RefinanceLoan.moveToElement(driver.findElement(By.id("renovatedNoRefinanceFix"))).click().perform();

System.out.println("renovated RefinanceFix No clickable");
Thread.sleep(2000);
driver.findElement(By.id("renovatedYesRefinanceFix")).click();
System.out.println("renovated RefinanceFix  Yes clickable");
Thread.sleep(2000);
//IF RENOVATED  REFINANCE   YES 
driver.findElement(By.id("renovationCostRefinanceFix")).sendKeys("340000");
Thread.sleep(2000);
//Do you want the new refinance loan to provide rehab funding?
Actions RehabFunding = new Actions(driver);
RehabFunding.moveToElement(driver.findElement(By.id("rehabFundingNoRefinanceFix"))).click().perform();

System.out.println("Rehab Funding No clickable");
Thread.sleep(2000);
driver.findElement(By.id("rehabFundingYesRefinanceFix")).click();
System.out.println("Rehab Funding  Yes clickable");
Thread.sleep(2000);
//IF Rehab Funding  YES = How much is the remaining rehab budget?
driver.findElement(By.id("rehabBudgetRefinanceFix")).sendKeys("340000");
//How much is the existing loan?
driver.findElement(By.id("existingLoanRefinanceFix")).sendKeys("569000");
//What is the current value
driver.findElement(By.id("currentValueRefinanceFix")).sendKeys("467000");
//What is the completed value?
driver.findElement(By.id("completedRefinanceFix")).sendKeys("565000");
//Target complete date
Actions CompleteDate = new Actions(driver);
CompleteDate.moveToElement(driver.findElement(By.id("constructionCompletedRefinanceFix")));
driver.findElement(By.id("constructionCompletedRefinanceFix")).sendKeys("18/07/2025");
//occupancyStatus
...
Thread.sleep(2000);
	 //Collateral Property 
	   WebElement  CollateralPropertyNo = driver.findElement(By.id("collateralpropertyNoRefinanceFix"));
	   ...
	   WebElement  CollateralPropertyYes = driver.findElement(By.id("collateralpropertyYesRefinanceFix"));
