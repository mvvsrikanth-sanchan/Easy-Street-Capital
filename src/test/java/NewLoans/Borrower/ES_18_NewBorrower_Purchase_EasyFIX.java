...
public class ES_18_NewBorrower_Purchase_EasyFIX {
  @Test
...
duplexPurchasingFix.moveToElement(driver.findElement(By.id("duplexPurchasingFix"))).click().perform();

System.out.println("Purchase details validation displayed");
//Purchase Price 
driver.findElement(By.id("purchasePricePurchaseFix")).sendKeys("659000");
//What is the rehab budget?
driver.findElement(By.id("rehabBudgetPurchaseFix")).sendKeys("329000");
//Do you want the loan to provide rehab funding?
Actions Rehab = new Actions(driver);
Rehab.moveToElement(driver.findElement(By.id("rehabFundYesPurchaseBuild"))).click().perform();

System.out.println("Rehab Fund clickable");
driver.findElement(By.id("rehabFundYesPurchaseBuild")).click();
System.out.println("Rehab Fund Yes clickable");

//What is the total square footage of the property?
driver.findElement(By.id("propertyAreaPurchaseFix")).sendKeys("2500");
//Total bedrooms
driver.findElement(By.id("totalBedroomsPurchaseFix")).sendKeys("2");
//Total bathrooms
driver.findElement(By.id("totalBathroomsPurchaseFix")).sendKeys("2");
Thread.sleep(5000);
//Year built?
driver.findElement(By.id("yearBuiltPurchaseFix")).sendKeys("2020");
//property has a pool
Actions NoPool = new Actions(driver);
NoPool.moveToElement(driver.findElement(By.id("poolNoPurchaseFix"))).click().perform();

System.out.println("Pool No clickable");
driver.findElement(By.id("poolYesPurchaseFix")).click();
System.out.println("Pool Yes clickable");
//square footage of the lot
driver.findElement(By.id("lotAreaPurchaseFix")).sendKeys("1400");
// What is the after-renovated value?
driver.findElement(By.id("renovationArvPurchaseFix")).sendKeys("350000");
Thread.sleep(5000);
//Target complete date


Actions date = new Actions(driver);
date.moveToElement(driver.findElement(By.id("constructionPurchaseFix")));
driver.findElement(By.id("constructionPurchaseFix")).sendKeys("18/09/2024");
// occupancyStatus
...
Thread.sleep(2000);
	 //Collateral Property 
	   WebElement  CollateralPropertyNo = driver.findElement(By.id("collateralpropertyNoPurchaseFix"));
	   ...
	   WebElement  CollateralPropertyYes = driver.findElement(By.id("collateralpropertyYesPurchaseFix"));
	...
	// occupancyStatus
	   ...
	   occupancyStatus1.sendKeys("COE + 7 days");
	   Thread.sleep(2000);
