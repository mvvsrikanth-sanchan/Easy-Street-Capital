...
//SERVICING SETUP
		/*
		 * WebElement ServicingSetup =
		 * driver.findElement(By.id("servicing-ServicingSetup")); JavascriptExecutor
		 * Servicing_Setup= (JavascriptExecutor)driver;
...
// Locate the button 
...

		{
			...
			if (Unlockbutton.isEnabled() == true) {
				...
				WebElement lockbutton = driver.findElement(By.id("saveandlockbtn"));

				JavascriptExecutor lock_Setup = (JavascriptExecutor) driver;

				lock_Setup.executeScript("arguments[0].click();", lockbutton);
...
// Add further test steps here
	 ...
	 * 
	 * ///////////////////////////////////////// WebElement unlocked =
	 * driver.findElement(By.id("savebtn")); //JavascriptExecutor unlock_Setup=
	 * (JavascriptExecutor)driver;
	 * //unlock_Setup.executeScript("arguments[0].click();", unlockSetup);
	 * Thread.sleep(3000); if (unlocked.isEnabled()) {
	 * System.out.println("Button is unlocked. Proceeding with automation.");
	 * 
	 * // Perform actions as the button is unlocked JavascriptExecutor unlock_Setup=
	 * (JavascriptExecutor)driver;
	 * unlock_Setup.executeScript("arguments[0].click();", unlocked); // Add further
	 * automation steps here
	 * 
	 * } else { WebElement unlockSetup = driver.findElement(By.id("unlockbtn")); if
	 * (unlockSetup.isEnabled()) {
	 ...
	 * }
	 * 
	 * Thread.sleep(3000); WebElement closePopup =
	 ...
	 * Thread.sleep(3000); WebElement Actualwire_Funddate =
	 * driver.findElement(By.name("actualwire_funddate")); JavascriptExecutor
	 * actualwire_funddate= (JavascriptExecutor)driver;
	 * actualwire_funddate.executeScript("arguments[0].click();",
	 * Actualwire_Funddate); Actualwire_Funddate.sendKeys("01-09-2024");
	 * Thread.sleep(3000); WebElement Scheduledfirstpaymentdate =
	 * driver.findElement(By.name("scheduledfirstpaymentdate")); JavascriptExecutor
	 * scheduledfirstpaymentdate= (JavascriptExecutor)driver;
	 * scheduledfirstpaymentdate.executeScript("arguments[0].click();",
	 * Scheduledfirstpaymentdate); Scheduledfirstpaymentdate.sendKeys("10-10-2024");
	 * Thread.sleep(3000); WebElement Servicingenddate =
	 * driver.findElement(By.name("servicingenddate")); JavascriptExecutor
	 * servicingenddate= (JavascriptExecutor)driver;
	 * servicingenddate.executeScript("arguments[0].click();", Servicingenddate);
	 * Servicingenddate.sendKeys("22-11-2024"); Thread.sleep(3000); WebElement Save1
	 * = driver.findElement(By.xpath(
	 * "/html/body/div/div/div/div[2]/div/div/div[3]/div[2]/div[2]/div/a"));
	 * JavascriptExecutor Save_funddate1= (JavascriptExecutor)driver;
	 * Save_funddate1.executeScript("arguments[0].click();", Save1);
	 * Thread.sleep(3000); driver.navigate().refresh(); //PAYMENT SETUP
	 * Thread.sleep(3000); WebElement PaymentSetup = driver.findElement(By.xpath(
	 * "/html/body/div/div/div/div[2]/div/ul/li[2]/a/span[2]")); JavascriptExecutor
	 * Payment_Setup= (JavascriptExecutor)driver;
	 * Payment_Setup.executeScript("arguments[0].click();", PaymentSetup);
	 * Thread.sleep(2000); WebElement DeferPayments = driver.findElement(By.xpath(
	 * "/html/body/div/div/div/div[2]/div/div/div[3]/div[2]/div[1]/div[1]/div/label/div"
	 * )); JavascriptExecutor Defer_Payments= (JavascriptExecutor)driver;
	 * Defer_Payments.executeScript("arguments[0].click();", DeferPayments);
	 * Thread.sleep(2000); WebElement DeferPayments1 = driver.findElement(By.xpath(
	 * "/html/body/div/div/div/div[2]/div/div/div[3]/div[2]/div[1]/div[1]/div/label/div"
	 ...
	 * Thread.sleep(2000); WebElement PartialPayments = driver.findElement(By.xpath(
	 * "/html/body/div/div/div/div[2]/div/div/div[3]/div[2]/div[1]/div[1]/div/label/div"
	 ...
	 * Thread.sleep(2000); WebElement PartialPayments1 =
	 * driver.findElement(By.xpath(
	 * "/html/body/div/div/div/div[2]/div/div/div[3]/div[2]/div[1]/div[1]/div/label/div"
	 ...
	 * Thread.sleep(2000); WebElement UserAutopay = driver.findElement(By.xpath(
	 * "/html/body/div/div/div/div[2]/div/div/div[3]/div[2]/div[1]/div[1]/div/label/div"
	 * )); JavascriptExecutor User_Autopay= (JavascriptExecutor)driver;
	 * User_Autopay.executeScript("arguments[0].click();", UserAutopay);
	 * Thread.sleep(2000); WebElement UserAutopay1 = driver.findElement(By.xpath(
	 * "/html/body/div/div/div/div[2]/div/div/div[3]/div[2]/div[1]/div[1]/div/label/div"
	 * )); JavascriptExecutor User_Autopay1= (JavascriptExecutor)driver;
	 * User_Autopay1.executeScript("arguments[0].click();", UserAutopay1);
	 * Thread.sleep(2000); WebElement PaymentSetup1 = driver.findElement(By.xpath(
	 * "/html/body/div/div/div/div[2]/div/ul/li[2]/a/span[2]")); JavascriptExecutor
	 * Payment_Setup1= (JavascriptExecutor)driver;
	...
	/*
	 * private void enableButton(ChromeDriver driver) { // TODO Auto-generated
	 * method stub WebElement unlockButton = driver.findElement(By.id("unlockbtn"));
	 * unlockButton.click();
	 */
}