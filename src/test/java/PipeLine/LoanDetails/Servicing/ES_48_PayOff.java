...
//Enter User Name
		...
		WebElement LoanId = driver
				.findElement(By.cssSelector("#row-0 > div:nth-child(1) > div:nth-child(1) > button:nth-child(1)"));

		Actions LoanIdSelect = new Actions(driver);
		LoanIdSelect.moveToElement(LoanId).perform();
		WebElement DealNavigation = driver.findElement(By.xpath(
				"/html/body/div/div/div[2]/div/div/div/div/div[3]/div/div[2]/div/div/div[2]/div[3]/div[1]/div/div/ul/li[2]/a"));
		...
		/*
		 * WebElement AddFeesandCredits = driver.findElement(By.xpath(
		 * "//*[@id=\"layout-wrapper\"]/div/div[2]/div/div/div[3]/div[4]/div/button)"));
		...
		Thread.sleep(1000);
		WebElement AddFeesCredits = driver
				.findElement(By.xpath("//*[@id=\"layout-wrapper\"]/div/div[2]/div/div/div[3]/div[4]/div/button)"));
		...
		Thread.sleep(1000);
		// SEND PAYOFF LETTER
		WebElement PayoffLetter = driver
				.findElement(By.xpath("//*[@id=\"layout-wrapper\"]/div/div[2]/div/div/div[6]/button[2]"));
		...
		Thread.sleep(3000);
		WebElement SendEmail = driver
				.findElement(By.xpath("//*[@id=\"layout-wrapper\"]/div/div[2]/div/div/div[5]/div[3]/div/div/input"));
		...
		// SEND PAYOFF LETTER
		WebElement PayoffLetters = driver
				.findElement(By.xpath("//*[@id=\"layout-wrapper\"]/div/div[2]/div/div/div[6]/button[2]"));
		...
		popup.executeScript("arguments[0].click();", Closepopup);
		Thread.sleep(3000);
		WebElement PayoffLetterPreview = driver
				.findElement(By.xpath("//*[@id=\"layout-wrapper\"]/div/div[2]/div/div/div[6]/button[1]"));
