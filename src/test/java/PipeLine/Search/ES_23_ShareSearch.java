...
//Enter User Name
		...
		WebElement backButton = driver.findElement(
				By.xpath("//*[@id=\"layout-wrapper\"]/div[2]/div/div/div/div/div[3]/div/div[2]/div[1]/button/span"));
		...
		// Everyone
		WebElement ClearAllview = driver.findElement(By.xpath(
				"//*[@id=\"layout-wrapper\"]/div[2]/div/div/div/div/div[3]/div/div[2]/div[2]/div/div[1]/div/div/div[1]/div[1]/div[1]/div[2]"));
		JavascriptExecutor Allview = (JavascriptExecutor) driver;
		Allview.executeScript("arguments[0].click();", ClearAllview);
		Thread.sleep(3000);
		WebElement Everyone = driver.findElement(By.id("sharesearch-everyone"));
		...
		Thread.sleep(3000);
		// Share Button
		WebElement SaveShare = driver.findElement(By.id("sharesearch-share"));
		JavascriptExecutor save = (JavascriptExecutor) driver;
		save.executeScript("arguments[0].click();", SaveShare);
		Thread.sleep(3000);
